...
class MenuState extends FlxState {
	...
	override public function create():Void {
		...
		var objectiveText:FlxText = new FlxText(0, 130, Reg.SCREEN_WIDTH,
			"Get as many points as you can by staying on the screen." + " Controls: WSAD or Arrow Keys. P or ESC pauses, M mutes");
